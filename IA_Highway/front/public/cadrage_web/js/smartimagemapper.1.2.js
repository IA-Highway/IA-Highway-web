...
smartImageMap.module = (function(options){
	...
	var displayPopertyPanel = function(hotspotObj){
		...
		ptable.append('<tr><td></td><td><a class="btn btnok" href="javascript:void(0)" id="okhotspot">'+translate('OK')+'</a>&#160;<a class="btn btndelete" href="javascript:void(0)" id="deletehotspot">'+translate('L�schen')+'</a></td></tr>');
